...
# 26 "C:/Program Files/CodeBlocks/MinGW/x86_64-w64-mingw32/include/sec_api/string_s.h" 3
...
int main() {
  ...
  do { if (!(one==1)) { printf("\033[1;31mError: at FILE=%s LINE=%d\033[0m\n", "test1.c", 12); printf("\033[1;32m  Check:%s but ", "one==1"); printf("one==%d\n", one); printf("\033[0m\n"); } } while (0);
  do { if (!(two==1)) { printf("\033[1;31mError: at FILE=%s LINE=%d\033[0m\n", "test1.c", 13); printf("\033[1;32m  Check:%s but ", "two==1"); printf("two==%d\n", two); printf("\033[0m\n"); } } while (0);
  ...
  double f[] = { 1.0, 2.0, 3.0, 4.0 }, *g = ({ void *p=malloc(sizeof(double)*4); do { if (!(p)) { printf("\033[1;31mError: at FILE=%s LINE=%d\033[0m\n", "test1.c", 20); printf("\033[1;32m  Check:%s but ", "p"); printf("_new() fail\n"); printf("\033[0m\n"); } } while (0); p; });
# 31 "test1.c"
}
