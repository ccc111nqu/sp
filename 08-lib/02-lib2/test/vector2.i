...
# 6 "../src/std2.h" 2
# 1 "C:/Program Files/CodeBlocks/MinGW/x86_64-w64-mingw32/include/complex.h" 1 3
# 51 "C:/Program Files/CodeBlocks/MinGW/x86_64-w64-mingw32/include/complex.h" 3
...
# 7 "../src/std2.h" 2
# 1 "C:/Program Files/CodeBlocks/MinGW/lib/gcc/x86_64-w64-mingw32/8.1.0/include/tgmath.h" 1 3 4
# 32 "C:/Program Files/CodeBlocks/MinGW/lib/gcc/x86_64-w64-mingw32/8.1.0/include/tgmath.h" 3 4
# 1 "C:/Program Files/CodeBlocks/MinGW/x86_64-w64-mingw32/include/math.h" 1 3 4
# 10 "C:/Program Files/CodeBlocks/MinGW/x86_64-w64-mingw32/include/math.h" 3 4
...
#pragma pack(pop)
# 33 "C:/Program Files/CodeBlocks/MinGW/lib/gcc/x86_64-w64-mingw32/8.1.0/include/tgmath.h" 2 3 4
# 8 "../src/std2.h" 2
# 40 "../src/std2.h"
...
# 4 "../src/vector2.h" 2
# 35 "../src/vector2.h"
void _vadd_i(int *a, int *b, int *c, int size); void _vadd_d(double *a, double *b, double *c, int size); void _vadd_c(double 
# 35 "../src/vector2.h" 3
_Complex 
# 35 "../src/vector2.h"
*a, double 
...
# 35 "../src/vector2.h"
*c, int size);;
void _vsub_i(int *a, int *b, int *c, int size); void _vsub_d(double *a, double *b, double *c, int size); void _vsub_c(double 
# 36 "../src/vector2.h" 3
_Complex 
# 36 "../src/vector2.h"
*a, double 
...
# 36 "../src/vector2.h"
*c, int size);;
void _vmul_i(int *a, int *b, int *c, int size); void _vmul_d(double *a, double *b, double *c, int size); void _vmul_c(double 
# 37 "../src/vector2.h" 3
_Complex 
# 37 "../src/vector2.h"
*a, double 
...
# 37 "../src/vector2.h"
*c, int size);;
void _vdiv_i(int *a, int *b, int *c, int size); void _vdiv_d(double *a, double *b, double *c, int size); void _vdiv_c(double 
# 38 "../src/vector2.h" 3
_Complex 
# 38 "../src/vector2.h"
*a, double 
...
*c, int size);;
# 72 "../src/vector2.h"
int _vsum_i(int a[], int n); double _vsum_d(double a[], int n); double 
# 72 "../src/vector2.h" 3
_Complex 
# 72 "../src/vector2.h"
_vsum_c(double 
...
# 72 "../src/vector2.h"
a[], int n);;
int _vproduct_i(int a[], int n); double _vproduct_d(double a[], int n); double 
# 73 "../src/vector2.h" 3
_Complex 
# 73 "../src/vector2.h"
_vproduct_c(double 
...
void _vadd_i(int *a, int *b, int *c, int size) { int *ta=a, *tb=b, *tc=c; for (int i=0; i<size; i++) { tc[i] = ta[i] + tb[i]; } }; void _vadd_d(double *a, double *b, double *c, int size) { double *ta=a, *tb=b, *tc=c; for (int i=0; i<size; i++) { tc[i] = ta[i] + tb[i]; } }; void _vadd_c(double 
# 3 "../src/vector2.c" 3
_Complex 
# 3 "../src/vector2.c"
*a, double 
...
_Complex 
# 3 "../src/vector2.c"
*ta=a, *tb=b, *tc=c; for (int i=0; i<size; i++) { tc[i] = ta[i] + tb[i]; } };
void _vsub_i(int *a, int *b, int *c, int size) { int *ta=a, *tb=b, *tc=c; for (int i=0; i<size; i++) { tc[i] = ta[i] - tb[i]; } }; void _vsub_d(double *a, double *b, double *c, int size) { double *ta=a, *tb=b, *tc=c; for (int i=0; i<size; i++) { tc[i] = ta[i] - tb[i]; } }; void _vsub_c(double 
# 4 "../src/vector2.c" 3
_Complex 
# 4 "../src/vector2.c"
*a, double 
...
# 4 "../src/vector2.c"
*ta=a, *tb=b, *tc=c; for (int i=0; i<size; i++) { tc[i] = ta[i] - tb[i]; } };
void _vmul_i(int *a, int *b, int *c, int size) { int *ta=a, *tb=b, *tc=c; for (int i=0; i<size; i++) { tc[i] = ta[i] * tb[i]; } }; void _vmul_d(double *a, double *b, double *c, int size) { double *ta=a, *tb=b, *tc=c; for (int i=0; i<size; i++) { tc[i] = ta[i] * tb[i]; } }; void _vmul_c(double 
# 5 "../src/vector2.c" 3
_Complex 
# 5 "../src/vector2.c"
*a, double 
...
# 5 "../src/vector2.c"
*ta=a, *tb=b, *tc=c; for (int i=0; i<size; i++) { tc[i] = ta[i] * tb[i]; } };
void _vdiv_i(int *a, int *b, int *c, int size) { int *ta=a, *tb=b, *tc=c; for (int i=0; i<size; i++) { tc[i] = ta[i] / tb[i]; } }; void _vdiv_d(double *a, double *b, double *c, int size) { double *ta=a, *tb=b, *tc=c; for (int i=0; i<size; i++) { tc[i] = ta[i] / tb[i]; } }; void _vdiv_c(double 
# 6 "../src/vector2.c" 3
_Complex 
# 6 "../src/vector2.c"
*a, double 
...
int _vsum_i(int a[], int n) { int r = (int) 0; for (int i=0; i<n; i++) { r += a[i]; } return r; }; double _vsum_d(double a[], int n) { double r = (double) 0; for (int i=0; i<n; i++) { r += a[i]; } return r; };;
int _vproduct_i(int a[], int n) { int r = (int) 1; for (int i=0; i<n; i++) { r *= a[i]; } return r; }; double _vproduct_d(double a[], int n) { double r = (double) 1; for (int i=0; i<n; i++) { r *= a[i]; } return r; };;
